    ...
    def do_GET(self):
        try:
            ...
            if self.path.endswith("/restaurants/new"):
                ...
                output = ""
                output += "<html><body>"
                output += "<h1><strong>Make a New Restaurant</strong></h1>"
            ...
            if self.path.endswith("/restaurants"):
                ...
                for restaurant in restaurants:
                    ...
                    output += "<button><a href ='/restaurants/%s/edit' >Edit </a></button> " % restaurant.id
                    output += "</br>"
                    # Objective 5 -- Replace Delete href
                    output += "<button><a href ='/restaurants/%s/delete'> Delete </a></button>" % restaurant.id
                    output += "</br></br></br>"
